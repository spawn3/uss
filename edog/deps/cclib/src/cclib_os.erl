...
get_load() ->
    ...
    Cached   = proplists:get_value(cached_memory, Mem),
    Buffered = proplists:get_value(buffered_memory, Mem),
    ...
    #load_info{
        ...
        avg15 = cpu_sup:avg15(),
        mem   = Mem,
        free  = ?to_kb(Free + Cached + Buffered)
    }.
